...
<h2>Alterar Cargo</h2> </br>
    <input type="text" id="novo cargo" placeholder="Cargo"> </br>
    ...
    <a  href="/trash"><input class="btn" type="button" value="Excluir Cargo"/> </a>
    <a  href="/alteracao"><input class="btn" type="button" value="Salvar Alterações"/> </a>
